...
import LocationImage from '../../images/carAdd/addcar.png'
import AddCarImg from '../../images/carAdd/car.png'
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
             <Image source={LocationImage} style={styles.localImage} />
              <Image source={AddCarImg} style={styles.AddCar} />
             <Text style={styles.text}>Add Your Car</Text>
             <Text style={styles.para}>Choose your location to start find the request around you</Text>
              <TouchableOpacity style={styles.Button} onPress={handleClick}>
                <Text style={{color:"white" , fontSize:16,}}>Add Now</Text>
              </TouchableOpacity>
